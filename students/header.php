...
<html>
	<head>
            ...
            <form action="" target="_blank">
                ...
                <div class="form-fields">
                    ...
                    <select name="academic_year_id">
                        <?php
                        $rs = doquery( "select * from academic_year where id in (select distinct(academic_year_id) from student_2_class where student_id=".$_SESSION["logged_in_students"]["id"].") and status = 1 order by start_date desc", $dblink );
                        if( numrows( $rs ) > 0 ) {
                            while( $r = dofetch( $rs ) ) {
                                ?>
        ...
        <script type="text/javascript">
			...
			function smscron(){
				$.get('<?php echo $site_url?>/send_sms<?php echo $_SESSION[ "session_school_id" ]?>.php', function( response ){
					if( response != "0" ) {
						setTimeout( function(){ smscron(); }, 3000 );
					}
				});
					...
					<ul class="nav ace-nav">
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
                            	<?php $student_image = get_student_meta($_SESSION["logged_in_students"]['id'], "student_image");?>
								<img class="nav-user-photo" src="<?php echo !empty($student_image)?$file_upload_url."student/".$student_image:"../assets/images/avatars/profileimg-default.png"?>" />
								<span class="user-info"> <small>Welcome,</small> <?php echo ucfirst((isset($_SESSION["logged_in_students"]) && $_SESSION["logged_in_students"]!="")?$_SESSION["logged_in_students"]["student_name"]:"Guest");?></span>
								<i class="ace-icon fa fa-caret-down"></i>
							</a>
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                                <li class="divider"></li>
								<?php if(isset($_SESSION["logged_in_students"])){?>
                                <li>
                                    <a href="logout.php">
