...
switch($tab){
	case 'add':
		include("modules/class/add_do.php");
	break;
	case 'edit':
		include("modules/class/edit_do.php");
	break;
	case 'delete':
		include("modules/class/delete_do.php");
	break;
	case 'status':
		include("modules/class/status_do.php");
	break;
	case 'bulk_action':
		include("modules/class/bulkactions.php");
	break;
}
?>
