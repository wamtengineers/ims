										...
										if(numrows($rs)>0){
                                            ...
                                            while($r=dofetch($rs)){           
                                                ...
                                                <tr class="<?php echo !empty( $r[ "result_id" ] ) && $r[ "result_status" ]==0?"info":""; echo !empty( $r[ "result_id" ] ) && $r[ "result_status" ]==1?"success":""; echo !empty( $r[ "result_id" ] ) && $r[ "result_status" ]==2?"warning":""; echo !empty( $r[ "result_id" ] ) && $r[ "result_status" ]==3?"danger":""?>">
                                                    ...
                                                    <td><input style="width: 100%;" type="text" name="student_marks[<?php echo $r[ "id" ]?>]" value="<?php echo $r[ "marks" ]?>"<?php echo !empty( $r[ "result_id" ] ) && ( $r[ "result_status" ]==1 || $r[ "result_status" ]==2 )?' disabled':''?>/><?php echo !empty( $r[ "reviewer" ] )?"<br>Reviewed By: ".unslash( $r[ "reviewer" ] ):""?></td>
                                                </tr>  
                                                <?php 
                                                $sn++;
                                            }
