...
$attendance = array();
$rs = doquery( "select * from student_attendance where date >= '".date_dbconvert( $date_from )."' and date <= '".date_dbconvert( $date_to )."' and student_id = '".$r["id"]."' order by date", $dblink );
?>
    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                Student: <?php echo unslash($r["student_name"])?>
            </small>
        </h1>
    </div>
    <div class="row">
                        ...
                        <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                            <div class="row">
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="col-md-10 col-sm-10 col-xs-12 search">
