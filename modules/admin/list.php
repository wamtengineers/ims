...
if( $_SESSION[ "logged_in_admin" ][ "school_id" ] != 0 ) {
	$extra=" and school_id='".$_SESSION[ "logged_in_admin" ][ "school_id" ]."'";
}
$is_search=false;
if(isset($_GET["q"])){
	$q=slash($_GET["q"]);
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xs-12">
                                    <div class="dataTables_length col-md-6 col-sm-6 col-xs-12" id="dynamic-table_length">
                                        <div class=""><a href="admin_manage.php?tab=add" class="btn btn-sm btn-primary">Add New Record</a></div>
                                    </div>
									...
									if(numrows($rs)>0){
										...
										while($r=dofetch($rs)){             
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($r["school_id"]==0) echo "All School"; else echo get_field($r["school_id"], "school","title");?></td>
                                                ...
                                                <td class="center">
                                                	<a href="admin_manage.php?id=<?php echo $r['id'];?>&tab=status&s=<?php echo ($r["status"]==0)?1:0;?>">
                                                    	<?php
														if($r["status"]==0){
															?>
                                                ...
                                                <td class="center">
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a class="green" title="Edit Record" href="admin_manage.php?tab=edit&id=<?php echo $r['id'];?>">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>
            
                                                        <a class="red"  title="Delete Record" onclick="return confirm('Are you sure you want to delete')" href="admin_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete">
                                                    ...
                                                    <div class="hidden-md hidden-lg">
                                                        <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                <li>
                                                                    <a title="Edit Record" href="admin_manage.php?tab=edit&id=<?php echo $r['id'];?>" class="tooltip-success" data-rel="tooltip">
                                                                        <span class="green">
                                                                ...
                                                                <li>
                                                                    <a onclick="return confirm('Are you sure you want to delete')" href="admin_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete" class="tooltip-error" data-rel="tooltip">
                                                                        <span class="red">
