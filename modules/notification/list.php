                            ...
                            <table ng-controller="StoreController as store" id="dynamic-table" class="table list table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="30%">Class Section / Department</th>
                                        <th width="15%">Students / Employee</th>
                                ...
                                <tbody>
                                	<?php 
									$sql="select * from notification where 1 ".$extra." order by date desc";
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<?php
														if($r[ "target" ]==0){
															...
															$department = array();
															$rs2 =doquery("select title from notification_2_department a inner join department b on a.department_id=b.id where notification_id='".$r["id"]."'", $dblink);
															if( numrows( $rs2 ) > 0 ) {
																while( $r2 = dofetch( $rs2 ) ) {
																	$department[] = $r2[ "title" ];
																}
                                                ...
                                                <td>
													...
													if($r[ "target" ]==0){
														...
														?>
                                                    	<a href="notification_manage.php?tab=employee&id=<?php echo $r['id'];?>" class="btn btn-sm btn-primary">Selected Employee</a>
                                                    	<?php 
													}
													?>
                                                </td>
