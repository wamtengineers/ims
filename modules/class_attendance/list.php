                        ...
                        <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                            ...
                            <table ng-controller="StoreController as store" id="dynamic-table" class="table list table-bordered table-hover">
                                ...
                                <tbody>
									...
									$class_attendance = doquery( "select * from student_daily_attendance a inner join admin b on a.taken_by = b.id where class_section_id = '".$r[ "id" ]."' and date='".date_dbconvert( $date )."'", $dblink );
									$sql="select a.id, a.title as section, b.class_name, c.title as class_level from class_section a inner join class b on a.class_id = b.id inner join class_level c on b.class_level_id=c.id where a.school_id = '".$_SESSION["current_school_id"]."' order by c.sortorder, b.class_name, a.title";
									...
									if(numrows($rs)>0){
										...
										while($r=dofetch($rs)){             
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">
                                                	<?php
                                                    $class_attendance = doquery( "select a.*, b.name from student_daily_attendance a inner join admin b on a.taken_by = b.id where class_section_id = '".$r[ "id" ]."' and date='".date_dbconvert( $date )."'", $dblink );
