...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="on_demand_fees_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd">
                ...
                <div class="form-group">
                	<div class="row">
                        ...
                        <div class="col-sm-9">
                            <select name="selected_students" id="selected_students" class="col-xs-12" title="Choose Option" onChange="$('.selected_class_students').toggle()">
                            ...
                            <a href="on_demand_fees_student_manage.php?parent_id=<?php echo $id?>" class="btn btn-sm btn-primary fancybox iframe selected_class_students"<?php echo $selected_students==0?' style="display: none"':''?>>On Demand Fees Student</a>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                	<div class="row">
                        <label class="col-sm-3 control-label no-padding-right" for="fees_title">Fees Title</label>
                        <div class="col-sm-9">
                ...
                <div class="form-group">
                	<div class="row">
                        <label class="col-sm-3 control-label no-padding-right" for="fees_amount">Fees Amount</label>
                        <div class="col-sm-9">
                ...
                <div class="clearfix form-actions">
                	<div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="submit" name="on_demand_fees_edit" title="Update Record">
