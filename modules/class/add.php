...
if(isset($_SESSION["class_manage"]["add"])){
	extract($_SESSION["class_manage"]["add"]);	
}
else{
	$class_level_id = "";
	$class_name="";
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="class_manage.php?tab=add" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();">
            	<?php
					$i=0;
				?>
                ...
                <div class="clearfix form-actions">
                	<div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="submit" name="class_add" title="Submit Record">
