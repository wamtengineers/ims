    ...
    <div class="row">
        <div class="col-xs-12">
        	<div class="align-right">
                <div class="btn-group bottom-20"> <a href="transaction_manage.php" class="btn btn-sm btn-primary">Back to List</a> </div>
            </div>
            <form class="form-horizontal" role="form" action="transaction_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-3 control-label no-padding-right">
                            <label for="account_id">Account To <span class="manadatory">*</span></label>
                        </div>
                        <div class="col-sm-9">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-3 control-label no-padding-right">
                            <label for="reference_id">Account From <span class="manadatory">*</span></label>
                        </div>
                        <div class="col-sm-9">
                ...
                <div class="form-group">
                    <div class="row">
                         <div class="col-sm-3 control-label no-padding-right">
                            <label for="datetime_added">Date/Time</label>
                        </div>
                        <div class="col-sm-9">
                ...
                <div class="clearfix form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="submit" name="transaction_edit" title="Submit Record">
