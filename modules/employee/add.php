...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal employee-form" role="form" action="employee_manage.php?tab=add" method="post" enctype="multipart/form-data" name="frmAdd">
                ...
                <div class="clearfix form-actions">
                	<div class="row">
                        <div class="col-md-9">
                            <button class="btn btn-info btn-new" type="submit" name="employee_add" title="Add Record">
