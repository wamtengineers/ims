...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal student-class" role="form" action="academic_year_class_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd">
                ...
                <div class="clearfix form-actions">
                	<div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="submit" name="academic_year_class_edit" title="Update Record" id="btnreload">
