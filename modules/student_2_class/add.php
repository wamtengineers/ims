...
if(isset($_SESSION["student_2_class_manage"]["add"])){
	extract($_SESSION["student_2_class_manage"]["add"]);	
}
else{
	$class_section_id="";
	$academic_year_id="";
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="student_2_class_manage.php?tab=add" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();">
            	<?php
					$i=0;
				?>
                	...
                	<div class="row">
                        ...
                        <div class="col-sm-9">
                            <select name="subject_ids[]" id="subject_id" multiple="multiple" class="select_multiple" title="Choose Option">
                                ...
                                <?php
                                $res=doquery("select * from subject where is_optional = 1 and school_id = '".$_SESSION["current_school_id"]."' order by sortorder",$dblink);
                                if(numrows($res)>0){
                                    while($rec=dofetch($res)){
                                    ?>
                ...
                <div class="clearfix form-actions">
                	<div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="submit" name="student_2_class_add" title="Submit Record">
