...
if(isset($_SESSION["parents_manage"]["add"])){
	extract($_SESSION["parents_manage"]["add"]);	
}
else{
	$name="";
	$mobile_number="";
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="parents_manage.php?tab=add" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();">
                ...
                <div class="clearfix form-actions">
                	<div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="submit" name="parents_add" title="Submit Record">
