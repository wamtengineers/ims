...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="notification_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd">
                	...
                	<div class="row">
                        ...
                        <div class="col-sm-9">
                            <select name="class_section_ids[]" id="class_section_id" multiple="multiple" class="select_multiple" title="Choose Option">
                                ...
                                <?php
                                $res=doquery("select a.*, b.class_name from class_section a inner join class b on a.class_id=b.id inner join subject_teachers c on a.id=c.class_section_id where c.employee_id='".$_SESSION[ "logged_in_teachers" ][ "id" ]."' and is_class_teacher=1 order by sortorder",$dblink);
                                if(numrows($res)>0){
                ...
                <div class="clearfix form-actions">
                	<div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="submit" name="notification_edit" title="Update Record">
