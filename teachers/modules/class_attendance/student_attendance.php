...
if(isset($_GET["id"]) && !empty($_GET["id"])){
	$attendance = array();
	$rs = doquery( "select * from student_attendance where date >= '".date_dbconvert( $date_from )."' and date <= '".date_dbconvert( $date_to )."' and student_id = '".slash( $_GET[ "id" ] )."' order by date", $dblink );
}
$extra='';
if(isset($_GET["date_from"])){
	$date_from=slash($_GET["date_from"]);
	$_SESSION["class_attendance"]["student_attendance"]["date_from"]=$date_from;
}
if(isset($_SESSION["class_attendance"]["student_attendance"]["date_from"]))
	$date_from=$_SESSION["class_attendance"]["student_attendance"]["date_from"];
else{
	$date_from=date("01/m/Y");
}
if(isset($_GET["date_to"])){
	$date_to=slash($_GET["date_to"]);
	$_SESSION["class_attendance"]["student_attendance"]["date_to"]=$date_to;
}
if(isset($_SESSION["class_attendance"]["student_attendance"]["date_to"]))
	$date_to=$_SESSION["class_attendance"]["student_attendance"]["date_to"];
else{
	$date_to=date("d/m/Y");
}
?>
    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                Student: <?php echo slash( $_GET[ "id" ]["student_name"])?>
            </small>
        </h1>
    </div>
    <div class="row">
